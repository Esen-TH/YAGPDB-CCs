{{/* User Variables */}}
{{$mods := cslice 606353862957203456 606353862340771841}}
{{$channelID := 658117898006691840}} {{/* Channel ID to send the bday msgs */}}
...
{{$commonError := "Correct date syntax is: `dd/mm/yyyy` - Example: `28/01/1998`"}}
{{$commonErrorInverted := "Correct date syntax is: `mm/dd/yyyy` - Example: `01/28/1998`"}}
